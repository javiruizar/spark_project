...
//  }
//
//  "KafkaSparkSession.build" should "create a SparkSession with correct configuration" in {
//    spark = KafkaSparkSession.build(testConfig)
//
...
//    val spark1 = KafkaSparkSession.build(testConfig)
//    val spark2 = KafkaSparkSession.build(testConfig)
//
//    try {
